...
Install the peer listed in the error (command matches your package manager), e.g. `npm install @tanstack/react-query` or `pnpm add @tanstack/react-query` for `react-query`.
